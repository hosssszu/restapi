...
public class EmployeeDaoImpl implements EmployeeDao {
    ...
    public void insertEmployee(Employees emp) {
        final String sql = "insert into employees(employeeId, employeeName , employeeEmail, employeeAddress) values(:employeeId,:employeeName,:employeeEmail,:employeeAddress)";
    ...
    public void updateEmployee(Employees emp) {
        final String sql = "update employees set employeeName=:employeeName, employeeAddress=:employeeAddress, employeeEmail=:employeeEmail where employeeId=:employeeId";
    ...
    public void deleteEmployee(Employees emp) {
        final String sql = "delete from employees where employeeId=:employeeId";
